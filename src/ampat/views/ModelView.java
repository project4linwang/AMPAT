...
public class ModelView extends ViewPart{
	public static final String ID = "ampat.views.ModelView";
	...
	class ViewLabelProvider extends LabelProvider implements ITableLabelProvider {
		public String getColumnText(Object obj, int index) {
			...
			if(obj!=null && obj!=""){
				...
				if(index>1){
					return Integer.toString(f.getBVector().get(index-2));
				}
			}
...
//        layout.setColumnData(col1, new ColumnWeightData(200));
	...
	private void SaveFeatures(){
		...
		logInit(fdlist.get(0).getBVector().size());
		if(fdlist!=null){
